...
namespace EpicBattlesImageDownloader
{
    public sealed class EpicBattlesImageDownloaderPlugin : IDeckBuilderPlugin
    {
        ...
        public Version Version => Version.Parse("0.6.0.0");
    ...
    internal static class Downloader
    {
        ...
        private static HttpClient CreateClient()
        {
            ...
            c.DefaultRequestHeaders.UserAgent.ParseAdd("OCTGN-Epic-Battles-Image-Downloader/0.6.0");
        ...
        {
            var json = await Client.GetStringAsync(BaseUrl + "manifest.json?v=0.6.0.0");
